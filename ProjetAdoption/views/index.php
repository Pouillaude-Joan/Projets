    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./views/connexionView.php">Se connecter</a>
          </li>
        </ul>
      </div>
    </div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="../images/accueil1.png" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="../images/accueil2.png" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="../images/accueil3.jpg" alt="Third slide">
            </div>
          </div>
           ...
           echo "<div class='col-lg-4 col-md-6 mb-4'>";
            echo "<div class='card h-100'>";
              ...
              echo "<div class='card-body'>";
                ...
                echo "<p class='card-text'>Détail de l'animal !
                </p>";
              echo "</div>";
