...
<body>
    ...
    <div class="container emp-profile">
        <form method="post" action="./doAdminModifyGestController.php">
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-6">
                    <div class="profile-head">
                        ...
                        <h6>
                            ...
                            <?php echo ($currGest->getNom() . ' '  . $currGest->getPrenom()); ?>
                    ...
                    <div class="tab-content profile-tab" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="row">
                                ...
                                <div>
                                    <input type="hidden" name="idU" value="<?php echo ($currGest->getId()); ?>" />
                                </div>
                                <div class="col-md-6">
                                    <input type="text" name="nom" value="<?php echo ($currGest->getNom()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="prenom" value="<?php echo ($currGest->getPrenom()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="mail" value="<?php echo ($currGest->getMail()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="tel" name="tel" value="<?php echo ($currGest->getTel()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="password" name="mdp" value="<?php echo ($currGest->getMotDePasse()); ?>" require />
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="row">
                                ...
                                <div>
                                    <input type="hidden" name="idA" value="<?php echo ($currGest->getAdresse()->getId()); ?>" />
                                </div>
                                <div class="col-md-6">
                                    <input type="text" name="rue" value="<?php echo ($currGest->getAdresse()->getRue()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="num" value="<?php echo ($currGest->getAdresse()->getNum()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="cp" value="<?php echo ($currGest->getAdresse()->getCodePostal()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="ville" value="<?php echo ($currGest->getAdresse()->getVille()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="pays" value="<?php echo ($currGest->getAdresse()->getPays()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
