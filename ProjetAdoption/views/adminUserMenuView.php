      ...
      <div class="table-wrapper">
        ...
        <table class="table table-striped table-hover">
          ...
          foreach ($allUsers as $user) {
            ...
            <tr>
              <td>' . $user->getId() . '</td>
              <td><a href="#"><img src="/examples/images/avatar/1.jpg" class="avatar" alt="Avatar">' . $user->getNom() . '</a></td>
              <td>' . $user->getPrenom() . '</td>
              <td>' . $user->getMail() . '</td>
              <td>' . $user->getTel() . '</td>
              <td><span class="status text-success">&bull;</span> Active</td>
              <td>
                <a href="./adminModifyUserController.php?id='.$user->getId() .'" class="settings" title="Settings" data-toggle="tooltip"><i class="material-icons">&#xE8B8;</i></a>
                <a href="./adminDeleteUserController.php?id='.$user->getId() .'" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE5C9;</i></a>
              </td>
            </tr>
          ');
            $i += 1;
        ...
        <div class="clearfix">
          <div class="hint-text">Montre <b><?php echo ($i); ?></b> sur <b><?php echo ($userCnt); ?></b> entrées</div>
          <ul class="pagination">
