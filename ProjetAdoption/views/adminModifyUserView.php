...
<body>
    ...
    <div class="container emp-profile">
        <form method="post" action="./doAdminModifyUserController.php">
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-6">
                    <div class="profile-head">
                        ...
                        <h6>
                            ...
                            <?php echo ($user->getNom() . ' '  . $user->getPrenom()); ?>
                    ...
                    <div class="tab-content profile-tab" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="row">
                                ...
                                <div>
                                    <input type="hidden" name="idU" value="<?php echo ($user->getId()); ?>" />
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="tel" name="tel" value="<?php echo ($user->getTel()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="password" name="mdp" value="<?php echo ($user->getMotDePasse()); ?>" require />
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="row">
                                ...
                                <div>
                                    <input type="hidden" name="idA" value="<?php echo ($user->getAdresse()->getId()); ?>" />
                                </div>
                                <div class="col-md-6">
                                    <input type="text" name="rue" value="<?php echo ($user->getAdresse()->getRue()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="num" value="<?php echo ($user->getAdresse()->getNum()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="cp" value="<?php echo ($user->getAdresse()->getCodePostal()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="ville" value="<?php echo ($user->getAdresse()->getVille()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="pays" value="<?php echo ($user->getAdresse()->getPays()); ?>" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
