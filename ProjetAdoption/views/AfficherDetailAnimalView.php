...
​
        ...
        <div class='row'>
          ...
          echo "<a href='#'><img class='card-img-top' src='" . $animalEnCours->getPhoto() . "' alt=''></a>";
          echo "<div class='card-body'>";
          echo "<h4 class='card-title'>" . $animalEnCours->getNom() . "</h4>";
          echo "<h5>" . $animalEnCours->getRace() . "</h5>";
          echo "<h5>" . $animalEnCours->getAge() . " ans</h5>";
          echo "<p class='card-text'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur!
                </p>";
          echo "<form action='../controllers/FaireAdoptionAnimalController.php' method='post'>
                <input type='hidden' name='id' value='" . $animalEnCours->getId() . "'/><button> Adopte moi ! </button></form></h4>";     
          echo "</div>";
