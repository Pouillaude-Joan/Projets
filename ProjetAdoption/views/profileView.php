...
<body>
    ...
    <div class="container emp-profile">
        <form method="post" action="./modifyProfileController.php">
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-6">
                    <div class="profile-head">
                        ...
                        <p class="proile-rating">Ancienneté : <span> <?php echo ($client->getAnciennete()); ?></span></p>
                    ...
                    <div class="tab-content profile-tab" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="password" name="mdp" value="<?php echo ($client->getMotDePasse()); ?>" readonly />
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p> <?php echo ($clientAdresse->getRue()); ?> </p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <p><?php echo ($clientAdresse->getNum()); ?> </p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <p><?php echo ($clientAdresse->getCodePostal()); ?> </p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <p><?php echo ($clientAdresse->getVille()); ?> </p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <p><?php echo ($clientAdresse->getPays()); ?> </p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
