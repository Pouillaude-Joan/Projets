...
​
        ...
        <div class='row'>
          ...
          echo "<form form enctype='multipart/form-data' action='../controllers/AdoptionController.php' method='post'><input type='hidden' name='idAnimal' value='" . $animalEnCoursAdoption->getId()."'>";
          echo "<a href='#'><img class='card-img-top' src='" . $animalEnCoursAdoption->getPhoto() . "' alt=''></a>";
          echo "<div class='card-body'>";
          echo "<h4 class='card-title'>" . $animalEnCoursAdoption->getNom() . "</h4>";
          echo "<h5>" . $animalEnCoursAdoption->getRace() . "</h5>";
          echo "<h5>" . $animalEnCoursAdoption->getAge() . " ans</h5>";
          ...
          echo "<div class='card h-100'>";
          echo "<div class='card-body'>";
          echo "<input type='hidden' name='idUtilisateur' value='" . $_SESSION['connectedUser']->getId()."'";
          echo "<h5>Nom : " . $_SESSION['connectedUser']->getNom() . "</h5>";
          echo "<h5>Prenom : " . $_SESSION['connectedUser']->getPrenom() . "</h5>";
          echo "<h5>Telephone : " . $_SESSION['connectedUser']->getTel() . "</h5>";
          echo "<h5>Ville : " . $_SESSION['connectedUser']->getAdresse()->getVille() . "</h5>";
          echo "<h5>Code postal : " . $_SESSION['connectedUser']->getAdresse()->getCodePostal() . "</h5>";
          echo "<h5>Pays : " . $_SESSION['connectedUser']->getAdresse()->getPays() . "</h5>";
          echo "<h5>Numero : " . $_SESSION['connectedUser']->getAdresse()->getNum() . "</h5>";
          echo "<h5>Rue : " . $_SESSION['connectedUser']->getAdresse()->getRue() . "</h5>";
          echo "<h5>Mail : " . $_SESSION['connectedUser']->getMail() . "</h5>";
          echo "</div>";
          echo "</div>";
          echo "</div>";
          ...
          echo "<div class='card h-100'>";
          echo "<div class='card-body'>";
          echo "<input name = 'identite' type = 'file' accept='.doc,.docx,.xml,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document' value = 'pièce d'identité a fournir' required /><br/>
                <input name = 'justificatif' type = 'file' accept='.doc,.docx,.xml,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document' value = 'justificatif de domicile' required /><br/><br/><br/>
                <button> Envoyer les documents </button></form>";
          echo "</div>";
          echo "</div>";
          echo "</div>";
          ?>
