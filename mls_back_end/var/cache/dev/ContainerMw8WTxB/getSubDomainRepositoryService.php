 ...
 */
class getSubDomainRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SubDomainRepository' shared autowired service.
     *
     * @return \App\Repository\SubDomainRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SubDomainRepository.php';

        return $container->privates['App\\Repository\\SubDomainRepository'] = new \App\Repository\SubDomainRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
