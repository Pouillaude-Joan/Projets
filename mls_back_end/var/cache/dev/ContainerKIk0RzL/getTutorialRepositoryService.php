...
class getTutorialRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TutorialRepository.php';

        return $container->privates['App\\Repository\\TutorialRepository'] = new \App\Repository\TutorialRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
